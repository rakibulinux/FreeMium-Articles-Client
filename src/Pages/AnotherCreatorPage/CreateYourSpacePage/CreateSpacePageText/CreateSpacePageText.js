...
const CreateSpacePageText = () => {
    return (
        <div className='border-[1px] border-y-gray-900 grid grid-cols-2 p-10 border-l-0 border-r-0'>
            <div className='border-[1px] px-4 border-r-gray-900 border-l-0 border-t-0 border-b-0'>
