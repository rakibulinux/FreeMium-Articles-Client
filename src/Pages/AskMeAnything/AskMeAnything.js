        ...
        <div className="w-full h-screen gap-4 p-8">
          <div className="w-full mt-8">
            ...
            <div className='flex items-center bg-[#343541] py-10 shadow-sm rounded-2xl'>
                  ...
                  <div>
                    <h1 className='text-base font-semibold text-gray-100'>How can I help you?</h1>
                  </div>
              </div>
              <div className='flex items-center bg-[#343541] py-10 shadow-sm rounded-2xl mt-1'>
                    ...
                    <h1 className='text-xl font-semibold text-white'>{firstWord}</h1>
                  </div>
                  <div>
                    <h1 className='text-base font-semibold text-gray-100'>Hello world!</h1>
                  </div>
              </div>
          ...
          <div className="p-2 my-2 rounded-lg flex gap-4 absolute top-[100%] w-[50%] left-[35%]">
            ...
            <div className="flex items-center">
                 <AiOutlineSend title="Sent" className="text-4xl text-[#1A8917] cursor-pointer" />
            </div>
          </div>
        </div>
      </form>
