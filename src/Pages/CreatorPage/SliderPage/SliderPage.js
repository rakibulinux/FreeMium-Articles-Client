    ...
    return (
        <div className='bg-[#4479FF] p-16'>
            <div className='text-center py-20'>
                ...
                <div className='flex justify-center lg:justify-between items-center flex-col lg:flex-row py-14 mt-20'>
                    <div className='px-1'>
                        <h1 className='text-3xl lg:text-5xl font-semibold text-white'>Get unlimited access to every story.</h1>
                    ...
                    <div className='px-1'>
                    <h1 className='text-3xl lg:text-5xl font-semibold text-white'>Support the voices you want to hear more from.</h1>
