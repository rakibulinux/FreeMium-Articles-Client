...
import { FaFolder,FaFile,FaPencilRuler,FaRegChartBar,FaExclamationCircle} from 'react-icons/fa';
...
<p><FaFolder className="w-16 h-16"/></p>
...
<p><FaFile className="w-16 h-16"/></p>
...
<p><FaPencilRuler className="w-16 h-16"/></p>
...
<p><FaRegChartBar className="w-16 h-16"/></p>
...
<p><FaExclamationCircle className="w-16 h-16"/></p>
