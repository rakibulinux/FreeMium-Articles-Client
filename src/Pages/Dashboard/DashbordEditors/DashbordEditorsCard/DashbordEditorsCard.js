...
const DashbordEditorsCard = () => {
  ...
  <div className="card-body p-4">
    <div className='flex justify-between border-[2px] border-b-[#ddd] border-x-0 border-t-0 py-2'>
        ...
        <span className='text-base mr-2 font-semibold text-gray-900'>Show</span>
        <select {...register("selectData")} className="select select-bordered w-52 max-w-xs">
        ...
        <span className='text-base mr-2 font-normal ml-1 text-gray-900'>Entries</span>
        </div>
        </form>
        <div className='flex items-center'>
           <span className='text-base text-gray-900 mr-2 font-semibold'>Search</span>
          <Search />
        </div>
    </div>
  </div>
