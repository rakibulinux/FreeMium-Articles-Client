        ...
        <div className="flex flex-row items-center p-4 relative">
              <div className=" sm:hidden  absolute text-xs text-gray-500 right-0 top-0 mr-4 mt-3">
                ...
                //  messgInfo? moment(messgInfo?.createdAt).startOf('mini').fromNow() : '' 
                          ...
                          <div className="sm:hidden lg:block text-xs truncate w-40">
                            {
                             ...
                             messgInfo && messgInfo?.message?.text?
                                  ...
                                  messgInfo && messgInfo?.message?.image?<span>send a image</span>
                                  : <span>connect you</span>
                            }
                            
                          </div>
                        </div>
                        <div className="hidden md:block lg:block flex-shrink-0 ml-2 self-end mb-1">
                            {
                        ...
                        :
                        <span className="flex items-center justify-center h-5 w-5 bg-red-400 text-white text-xs rounded-full">
