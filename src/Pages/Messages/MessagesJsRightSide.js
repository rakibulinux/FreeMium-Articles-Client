...
const MessagesJsRightSide = ({currentFriend,friends,messageInputHandl,newMessages,sendImage,
  sendMessage,getMessage,singleUsers,scrollRef,emojiHnadler}) => {
...
const emojis =['😨','🤔','😕','😬','😊','😳','😲','😟','😒','😞','🤣','🔫','🤮','😋','😭','😢','👍','😣','🤣','😈','😠','❤️','💘','💕','💖','😀','😎','😉']
            ...
            <div className="h-full overflow-y-auto">
              ...
              {/* <div className="col-start-1 col-end-8 p-3 rounded-lg">
                ...
                </div> */}
                {
                  ...
                  getMessage?.map(m=>m.senderId===singleUsers?._id?
                    ...
                    <p>{format(m?.message?.createdAt)}</p>
                  </div>
                :

                 <div  className="col-start-1 col-end-8 p-3 rounded-lg">
                 <div className="flex flex-row items-center">
                 <img src={picture} alt = "img" className="flex items-center justify-center h-10 w-10 rounded-full  flex-shrink-0">
  ...
  <label tabIndex={0} className="cursor-pointer">😀</label>
  <ul tabIndex={0} className="dropdown-content menu grid grid-cols-6 p-2 shadow bg-base-100 rounded-box w-52">
    {
emojis?.map(e=><span className='cursor-pointer' onClick={()=>emojiHnadler(e)}>{e}</span>)
    }
    {/* <li><a>Item 1</a></li> */}
    
  </ul>
</div>
               {/* <label className='cursor-pointer' htmlFor="emoji"></label> */}
              </div>
            </div>
            <div className="ml-6">
