                    ...
                    m.senderId === singleUsers?._id ? (
                      ...
                      >
                        ...
                        >
                          ...
                          <div key={m?._id + 5} className="relative mr-3 text-sm bg-indigo-100 py-2 px-4 shadow rounded-xl">
                            <div key={m?._id + 5}>{m?.message?.text===""?<img src={m?.message?.image} alt="img"></img>: m?.message?.text}</div>
                          </div>
                        </div>
                      </div>
                    ) : (
