...
const OurStory = () => {
    ...
    return (
        <div>
            <h1 className=' text-center text-4xl md:text-5xl lg:text-8xl my-32 font-semibold font-sans'>Every idea needs a <span className='font-bold'>Medium.</span></h1>
            <div className='grid grid-cols-1 md:grid-cols-2'>
                ...
                <StyleRoot className='border'>
                    <div style={styles.rotateIn}>
                        <img className='m-14 w-5/6' src="https://i.ibb.co/w6JsdHZ/article-writing-removebg-preview.png" alt="" />
                    </div>
                </StyleRoot>
            ...
            <div className='bg-[#ffd1b9]'>
                ...
                <div className='mt-10 mx-10 grid grid-cols-1 md:grid-cols-3'>
                    ...
                    <div className='flex mb-5'>
                        <img className='w-12 rounded-full' src="https://i.ibb.co/bKtcK1V/professional-Picture-Real.png" alt="" />
                    ...
                    <div className='flex mb-5'>
                        <img className='w-12 rounded-full' src="https://miro.medium.com/fit/c/20/20/1*XL5QclUh4RwVmsq8szytzg.png" alt="" />
                    ...
                    <div className='flex mb-5'>
                        <img className='w-12 rounded-full' src="https://i.ibb.co/yV0kPRJ/20181226-154653-01-1.jpg" alt="" />
            ...
            <div>
                <div className='grid grid-cols-1 md:grid-cols-2 bg-black'>
                    ...
                    <div className='border'>
                        <img className='m-10 w-40  rounded-full' src="https://i.ibb.co/qdqbwxr/Md-Al-Kafee.jpg" alt="" />



                        <p className='text-white  mx-16 lg:mr-48 mb-10 font-semibold text-lg'>
                            "Medium is a great place to read and learn from a wide range of authors. It’s not muddied up by ads. It feels like one of the few pure places to go online." <br /> <br />
                            Sojeeb Islam
                        </p>
                    </div>
                ...
                <div className='bg-black text-white  py-10'>
                    <h2 className='text-4xl md:text-6xl lg:text-8xl text-center mx-10 md:mx-16  lg:mx-44 font-semibold'>Create the space for your thinking to take off.</h2>
                    ...
                    <Link to='' className='flex justify-center'><button className='text-green-600 btn btn-outline rounded-full border-green-600'>Write On Freemium</button></Link>
                </div>
            </div>
            <div>
                <div className='bg-green-600 text-white  py-10'>
                    <h2 className='text-4xl md:text-6xl lg:text-8xl text-center mx-10 md:mx-16  lg:mx-44 font-semibold'>Get more with membership.</h2>
                    <p className='mx-16 lg:mx-96 my-5 text-center font-semibold'>
                        Become a Medium member to enjoy unlimited access and directly support <br /> the writers you read most.
                    </p>
                    <Link to='' className='flex justify-center'><button className='text-white btn btn-outline rounded-full border-white'>See Membership Options</button></Link>
                </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 bg-green-600'>
                    <div className='border  lg:justify-center lg:items-center'>
                        ...
                        <img className='h-64 ' src="https://i.ibb.co/Fn2K8HV/360-F-335937452-Kym-RAu0wm-Am-Yi-Rrif4-Aglx-Kz28-Iz-Lv-ZW-removebg-preview.png" alt="" />
                    ...
                    <div className='border  lg:justify-center lg:items-center'>
                        ...
                        <img className='h-64' src="https://i.ibb.co/0CSccCB/content-writing-removebg-preview.png" alt="" />
                        <p className='m-8 font-semibold text-white '>
