...
const PaymentForm = () => {
    ...
    return (
        <div >
          <div className={isDarkMode ?'grid justify-center':'bg-base-200 grid justify-center'}>
    
      <p className={isDarkMode ?"py-6 font-bold text-center text-4xl text-gray-200":"py-6 font-bold text-center text-4xl text-gray-900"}>Get unlimited access to <br /> everything on FreeMium</p>
      <p className={isDarkMode ?'text-center text-gray-200':'text-center text-gray-900'}>Plans starting at less than 100 Tk/week. Cancel anytime.</p>
      <p className={isDarkMode ?'text-center text-gray-200':'text-center text-gray-900'}>No ads</p>
      <p className={isDarkMode ?'text-center text-gray-200':'text-center text-gray-900'}>Access on any device</p>
    </div>
            <div className={isDarkMode ?"hero min-h-screen":"hero min-h-screen bg-base-200"}>
    ...
    <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl mb-10 bg-base-100">
      ...
      className="card-body">
        <div className="form-control">
          ...
          name="email"
          type="email" required placeholder="email" className="input input-bordered text-gray-900" />
        </div>
        <div className="form-control">
          <label className="label">
          ...
          name="name" required
          type="text" placeholder="email" className="input input-bordered text-gray-900" />
        </div>
        <div className="form-control">
          <label className="label">
