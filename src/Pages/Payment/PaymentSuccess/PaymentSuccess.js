...
//    
    ...
    return (
        <div>
        <h1 className="text-4xl text-center text-sky-700 my-2">Congratulation Successfully Paid..</h1>
        <h2 className="text-2xl text-center text-orange-600 my-3">Payment history</h2>
  ...
  <table className="table w-full">
    ...
    <tbody>
      ...
      <tr className="active">
        ...
        <td className='text-center font-bold'>{paymentUser.transactionId}</td>
  ...
  <table className="table w-full">
    ...
    <tbody>
      ...
      <tr className="active">
        ...
        <div>
          <h4 className='text-2xl text-center font-bold my-3'> Save your transaction ID for later use</h4>

          <h4 className='text-2xl text-center font-bold my-3 print:hidden'> Back to <Link className='text-blue-600 underline underline-offset-4' to="/">Home</Link> </h4>
          <button onClick={()=> window.print()} className="btn btn-outline btn-primary btn-wide my-5 mx-4 ml-auto block print:hidden">Print</button>
        </div>
        </div>
    );
};
