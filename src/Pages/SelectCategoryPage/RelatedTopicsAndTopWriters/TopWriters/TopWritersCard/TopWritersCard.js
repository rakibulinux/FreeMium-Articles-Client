    ...
    return (
        <div>
            ...
            <div className="card-body">
              ...
              <div className='px-2'>
                <h3 className={isDarkMode ? 'text-gray-900 font-semibold font-serif':'text-gray-900 font-semibold font-serif'}>{name}</h3>
                <p className={isDarkMode ? "text-gray-900":"text-gray-900"}>I am Java programmer, blogger, working on Java, J2EE, UNIX, FIX Protocol. I share Java tips on</p>
              </div>
