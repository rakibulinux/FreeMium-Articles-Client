    ...
    <div className="py-7">
      <div className="collapse border-[1px] border-b-[#fff] border-x-0 border-t-0">
        ...
        <div className="collapse-title bg-[#000000] text-[#ffff] peer-checked:bg-[#000000] peer-checked:text-white flex justify-between">
          <h4 className="text-2xl">Do you need a FreeMium membership to publish in the Partner Program?</h4>
        ...
        <div className="collapse-content bg-[#000000] text-[#000000] peer-checked:bg-[#000000] peer-checked:text-white">
          ...
          No, you don’t have to be a paying FreeMium member to join the Partner Program and start earning. If you do subscribe to be a member, your monthly membership fees will directly support writers on FreeMium.
          </p>
        </div>
      </div>
      <div className="collapse border-[1px] border-b-[#fff] border-x-0 border-t-0">
...
Partner Program writers are paid monthly based on how much time FreeMium members spend reading their stories. The longer members read, the more writers earn.
...
Learn more about how Partner Program earnings are calculated here.
      ...
      <div className="collapse border-[1px] border-b-[#fff] border-x-0 border-t-0">
        <input type="checkbox" className="peer" />
        <div className="collapse-title bg-[#000000] text-[#ffff] peer-checked:bg-[#000000] peer-checked:text-white flex justify-between">
          <h4 className="text-2xl">How does the Partner Program work for publications?</h4>
          <FaLongArrowAltDown className="text-xl" />
        </div>
        <div className="collapse-content bg-[#000000] text-[#000000] peer-checked:bg-[#000000] peer-checked:text-white">
          <p className="text-lg font-normal">
      ...
      <div className="collapse border-[1px] border-b-[#fff] border-x-0 border-t-0">
        <input type="checkbox" className="peer" />
        <div className="collapse-title bg-[#000000] text-[#ffff] peer-checked:bg-[#000000] peer-checked:text-white flex justify-between">
          <h4 className="text-2xl">Can non-members read stories that are published through the Partner Program?</h4>
          <FaLongArrowAltDown className="text-xl" />
        </div>
        <div className="collapse-content bg-[#000000] text-[#000000] peer-checked:bg-[#000000] peer-checked:text-white">
          <p className="text-lg font-normal">
...
Referrals landing page: Every Partner Program writer has a personalized referral landing page where readers can become a paying member for unlimited access to their writing, plus everything else on FreeMium. Writers can promote their landing page on other platforms to try to drive more Referred Memberships. 
...
You may promote your referral link in your posts. As a best practice, we recommend that the link is as unobtrusive as possible (stick it at the beginning or bottom of your story) and that you give the reader a sense of why they should support your work and what they can expect. If it’s not already explained in your message, you’ll also need to let your readers know that you’ll receive a portion of their membership fees. Here is a helpful Federal Trade Commission FAQ about affiliate referrals. 
      ...
      <div className="collapse border-[1px] border-b-[#fff] border-x-0 border-t-0">
        ...
        <div className="collapse-content bg-[#000000] text-[#000000] peer-checked:bg-[#000000] peer-checked:text-white">
          <p className="text-lg font-normal">
          No. Promoting Referred Memberships is optional and in addition to earnings generated based on member read time. FreeMium writers who prefer to earn solely based on member reading time are more than welcome to do so.
          </p>
        </div>
      </div>
      <div className="collapse border-[1px] border-b-[#fff] border-x-0 border-t-0">
