...
const GiftMembership = () => {
    ...
    return (
        ...
        <div className='text-center'>
            <h1 className='text-4xl'>Gift a year of Medium<br /> membership.</h1>
            <p>Give the readers and deep thinkers in your life a year of Medium membership for $50.</p>
            
            </div>
            <div>
                <h1 className='text-xl font-extrabold mt-10'>Who is this gift for?</h1>
                <p>The recipient will receive an email on the delivery date with a coupon code to redeem their membership. Purchasing more than 10 gifts? Submit a request at <span className='link'>help.medium.com</span></p>
            </div>
            <div>
                <div className="form-control w-full max-w-xs">
                    ...
                    <input type="email" placeholder="Type your name" className="input input-bordered w-full max-w-xs" />
                    <label className="label">
                ...
                <div className="form-control w-full max-w-xs mt-6">
                    ...
                    <textarea className="textarea textarea-bordered" placeholder="Add your message"></textarea>
                    <button className='btn btn-success rounded-full text-white m-12'>Continue to payment</button>
                </div>
            </div>
