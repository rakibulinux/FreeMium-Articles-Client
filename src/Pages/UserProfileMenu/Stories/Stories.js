      ...
      <div className="flex row">
        <div className=" basis-3/4 mb-10">
          <div className="flex justify-between">
            <h1 className={isDarkMode ?"text-4xl font-bold text-gray-100":"text-4xl font-bold text-gray-900"}>Your stories</h1>
            <div>
              <Link
          ...
          <div className="tabs mt-10">
            <Link className={isDarkMode ? "tab tab-bordered tab-active text-gray-100":"tab tab-bordered text-gray-900 tab-active"}>Drafts</Link>
            <Link className={isDarkMode ? "tab tab-bordered text-gray-100":"tab tab-bordered text-gray-900"}>Published</Link>
            <Link className={isDarkMode ? "tab tab-bordered text-gray-100":"tab tab-bordered text-gray-900"}>Responses</Link>
          </div>
        </div>
